...
(function () {
  ...
  var WHY = [
    ...
    { t: 'השוואה חכמה בין תרחישים', b: 'הזיזו את המחוונים ובדקו איך תקופת מימון קצרה או ארוכה יותר משפיעה על ההחזר החודשי — וכך תבחרו את <a href="car-loan">מסלול המימון</a> שהכי משתלם עבורכם.' }
  ];
  ...
  var COLS = [
    ...
    { ic: '<path d="M3 13l2-5a2 2 0 0 1 1.9-1.3h10.2A2 2 0 0 1 19 8l2 5M5 13h14v5H5zM7.5 16h.01M16.5 16h.01"/>', t: 'מקדמה / טרייד-אין', b: '<a href="trade-in">עסקת טרייד-אין</a> על הרכב הישן או מקדמה מקטינות את סכום המימון ואת ההחזר החודשי.' }
  ];
