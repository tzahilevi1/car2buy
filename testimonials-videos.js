...
(function () {
  ...
  window.Car2Buy.TESTIMONIALS = [
    { video: V + 'testimonial-01.mp4', name: '', car: '' },
    { video: V + 'testimonial-02.mp4', name: '', car: '' },
    { video: V + 'testimonial-03.mp4', name: '', car: '' },
    { video: V + 'testimonial-04.mp4', name: '', car: '' },
    { video: V + 'testimonial-05.mp4', name: 'מוחמד נטור', car: '' },
    { video: V + 'testimonial-06.mp4', name: '', car: '' },
    { video: V + 'testimonial-07.mp4', name: '', car: '' },
    { video: V + 'testimonial-08.mp4', name: '', car: '' },
    { video: V + 'testimonial-09.mp4', name: '', car: '' },
    { video: V + 'testimonial-10.mp4', name: '', car: '' },
    { video: V + 'testimonial-11.mp4', name: '', car: '' }
  ];
})();
