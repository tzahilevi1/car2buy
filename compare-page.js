...
(function () {
  ...
  var WHY = [
    ...
    { t: 'רמת גימור ובטיחות', b: 'ב<a href="/">Car2Buy</a> אתם יכולים להשוות את אותו דגם רכב לגרסאות השונות שיש לו. ככה תוכלו לראות איזו רמת גימור בטיחותית יותר ובאיזו גרסה יש את התוספות שאתם מחפשים (תא מטען בפתיחה חשמלית, גג שמש פנורמי, מושב נהג בכוונון חשמלי ועוד).' },
    { t: 'חיסכון בכסף', b: 'הדבר הראשון שתשימו לב אליו בהשוואת רכבים לפני קניה אלה המחירים של הרכבים שאתם משווים. ההשוואה חכמה יכולה לגלות לכם איזה רכב אתם יכולים לקנות מבלי להתפשר ולוודא שזאת <a href="car-loan">האפשרות המשתלמת</a> עבורכם.' }
  ];
  ...
  var DATA = [
    ...
    { ic: '<path d="M3 22h13M5 22V8l6-4 5 3v15M8 11h3M8 15h3"/><path d="M16 10l3 1v9a1.5 1.5 0 0 1-3 0V6"/>', t: 'צריכת דלק', b: 'כחלק מההשוואה בדקו איזה <a href="finance-electric">רכב חסכוני</a> יותר, וברכבים חשמליים את טווח הנסיעה וקצב הטעינה.' },
  ...
  var HOW = [
    ...
    { t: 'שלב 5: קבלו החלטה', b: 'הגיעו מוכנים <a href="models">לרכישת הרכב החדש שלכם</a>.' }
  ];
