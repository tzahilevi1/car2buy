...
<meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self' 'unsafe-inline' https://connect.facebook.net 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://ssl.google-analytics.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://ad.doubleclick.net https://www.gstatic.com https://s3.eu-central-1.amazonaws.com/maskyoo-cdn/; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' data: https://fonts.gstatic.com; img-src 'self' data: https:; media-src 'self'; connect-src 'self' https://tdxhqpauuqawcoivjnnm.supabase.co https://api.ipify.org https://www.facebook.com https://connect.facebook.net https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com https://*.analytics.google.com https://*.google-analytics.com https://region1.google-analytics.com https://*.g.doubleclick.net https://ad.doubleclick.net https://stats.g.doubleclick.net https://www.google.com https://www.google.co.il https://www.googleadservices.com https://www.gstatic.com https://pagead2.googlesyndication.com https://s3.eu-central-1.amazonaws.com/maskyoo-cdn/; base-uri 'self'; form-action 'self'; object-src 'none'; upgrade-insecure-requests">
<!-- Google Tag Manager -->
...
(function(){
  ...
  f.addEventListener('submit',function(e){e.preventDefault();var n=(f.name.value||'').trim(),p=(f.phone.value||'').trim();
    if(n.length<2){f.name.focus();return;} if(!/^0(5\\d{8}|7\\d{8}|[234689]\\d{7})$/.test(p.replace(/\\D/g,'').replace(/^972/,'0'))){f.phone.focus();f.phone.style.borderColor='#e25555';return;}
