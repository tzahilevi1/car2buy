...
(function () {
  ...
  var tradeBanner = '<div class="rc-banner"><div class="bt"><h3>רוצים להחליף את הרכב הישן?</h3><p>לקבלת הצעת מחיר בעסקת טרייד-אין</p></div><a class="btn btn-gold btn-lg" href="trade-in">התחילו כאן ←</a></div>';
  var helpBanner = '<div class="rc-banner help"><div class="bt"><h3>לא מצאתם את הרכב המושלם?</h3><p>תמיד אפשר לבקש ייעוץ אישי</p></div><div class="rc-banner-btns"><a class="btn btn-gold btn-lg" href="https://wa.me/972723319929" target="_blank" rel="noopener">דברו איתנו בוואטסאפ</a><button type="button" class="btn btn-ghost btn-lg" data-open-appt style="color:#fff;border-color:rgba(255,255,255,.4);">קובעים פגישה בקליק</button></div></div>';
  ...
  // content columns
  var COLS = [
    { t: 'איך לבחור את הרכב הבא שלכם?', b: 'ב-Car2Buy אנחנו מבינים שרכישת רכב היא החלטה משמעותית הדורשת מחשבה, השוואה ובחינה מעמיקה. לכן הקפדנו לבחור ולהציג בפניכם את הרכבים המומלצים בשוק הישראלי, תוך התחשבות מלאה בצרכים המגוונים של כל נהג ונהגת. הרשימה נבנתה בקפידה על ידי צוות מומחים שבחנו מאות דגמים ובחרו רק את המובילים בקטגוריה — לפי <a href="finance-electric">חיסכון בדלק</a>, עלויות תחזוקה, בטיחות, נוחות ויחס מחיר-תמורה.', img: at(3) },
    { t: 'מגוון רחב לכל צורך ותקציב', b: 'בין אם אתם משפחה המחפשת רכב מרווח ובטוח, זוג צעיר המעוניין ברכב עירוני חסכוני, או נהג שמחפש רכב שטח מתקדם — תמצאו כאן את המענה המושלם. אנחנו מציעים פתרונות מימון גמישים המותאמים לכל תקציב, ליווי צמוד לאורך כל תהליך הרכישה ו<a href="contact">ייעוץ מקצועי</a> ללא התחייבות.', img: at(9) },
    { t: 'שירות אישי ומקצועי', b: 'Car2Buy מתחייבת לשקיפות מלאה ולשירות אמין. כל רכב בקטגוריית הרכבים המומלצים עבר סקירה, ואנחנו מספקים אותו 0 ק״מ עם אחריות יצרן מלאה. אנחנו מאמינים שלקוח מרוצה הוא הפרסום הטוב ביותר שלנו — <a href="contact">צרו איתנו קשר</a> עוד היום וגלו מדוע אלפי לקוחות בחרו בנו.', img: at(15) }
  ];
